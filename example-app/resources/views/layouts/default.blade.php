...
<head>
    ...
    <title>SE CAMP1 | @yield('title', '#12')</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">SE CAMP1</span>
            </a>
    ...
    <script src="{{url('assets/plugins/datatables-buttons/js/buttons.html5.min.j')}}s"></script>
